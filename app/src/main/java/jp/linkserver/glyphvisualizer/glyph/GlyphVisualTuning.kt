...
object GlyphVisualTuningDatabase {
    private val entries: Map<GlyphVisualTuningKey, GlyphVisualTuning> = mapOf(
        ...
        // Phone (4a) Pro matrix
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_BAR) to GlyphVisualTuning(dynamics = 0.3f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_FIELD) to GlyphVisualTuning(dynamics = 0.3f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_CIRCLE) to GlyphVisualTuning(dynamics = 0.35f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_RIPPLE) to GlyphVisualTuning(dynamics = 0.7f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_SPECTRUM) to GlyphVisualTuning(dynamics = 0.75f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_SPECTRUM_CENTER) to GlyphVisualTuning(dynamics = 0.75f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_SPECTRUM_BOTTOM) to GlyphVisualTuning(dynamics = 0.8f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_SPECTROGRAM) to GlyphVisualTuning(dynamics = 0.6f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_SPECTRUM_ANALYZER) to GlyphVisualTuning(dynamics = 0.5f),
        ...
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_RADIAL_SPECTRUM) to GlyphVisualTuning(dynamics = 0.75f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_RAIN) to GlyphVisualTuning(dynamics = 0.5f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_WAVE_FIELD) to GlyphVisualTuning(dynamics = 0.85f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_SKYLINE) to GlyphVisualTuning(dynamics = 0.7f),
        key(GlyphDeviceProfile.PHONE4A_PRO_MATRIX, GlyphPatternRegistry.P3_MATRIX_PULSE_GRID) to GlyphVisualTuning(dynamics = 0.9f),
...
internal class SpectrumVisualDynamicsState {
    ...
    fun apply(
        ...
        for (index in values.indices) {
            ...
            output[index] = blendVisualDynamics(sharedBand, expandedBands[index], blend)
        }
        return output
    }
